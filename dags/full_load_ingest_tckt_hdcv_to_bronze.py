...
ENV_VARS = {"ENV_JOB_RUN": "dev",
            ...
            "MINIO_LAKE_HOUSE_PATH": Variable.get("MINIO_LAKE_HOUSE_PATH"),
                          ...
                          "CHP_TCKT_API_ENDPOINT": Variable.get("CHP_TCKT_API_ENDPOINT"),
                          "CHP_TCKT_API_USERNAME": Variable.get("CHP_TCKT_API_USERNAME"),
                          "CHP_TCKT_API_PASSWORD": Variable.get("CHP_TCKT_API_PASSWORD"),
...
with DAG(
    ...
    tags=['full', 'ingest', 'tckt', 'chp_hdcv']
) as dag:
